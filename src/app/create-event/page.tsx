...
export default function CreateEventPage() {
  ...
  const handleSubmit = async (status: "draft" | "published") => {
    ...
    toast.success(status === "draft" ? "Draft saved" : "Event published");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {isMounted && (
        <>
          {/* ---------------- Header ---------------- */}
          <header className="sticky top-15 z-10 bg-gray-50/90 backdrop-blur border-b border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Field label="Ticket Price (USD)">
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateField("ticketPrice", e.target.value)
                        }
                        placeholder="0.00"
                  ...
                  <Field label="Total Capacity">
                    <input
                      ...
                      onChange={(e) =>
                        updateField("totalCapacity", e.target.value)
                      }
                      placeholder="e.g. 100"
                      className="input"
                    />
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl bg-gray-900 text-white p-5">
                ...
                <p className="text-xs text-gray-300 leading-relaxed">
                  Events with high-quality cover images and detailed
                  descriptions receive 65% more engagement on average.
                </p>
              </div>
            </div>
          </main>
